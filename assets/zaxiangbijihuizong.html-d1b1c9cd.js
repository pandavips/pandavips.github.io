...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="debian换阿里云源" tabindex="-1"><a class="header-anchor" href="#debian换阿里云源" aria-hidden="true">#</a> debian换阿里云源</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>deb http://mirrors.aliyun.com/debian/ stretch main non-free contrib
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="解决npm下载二进制巨慢的问题" tabindex="-1"><a class="header-anchor" href="#解决npm下载二进制巨慢的问题" aria-hidden="true">#</a> 解决NPM下载二进制巨慢的问题</h2>`,25),g=n("code",null,".npmrc",-1),k=n("code",null,"antfu",-1),f={href:"https://antfu.me/posts/npm-binary-mirrors",target:"_blank",rel:"noopener noreferrer"},x=i(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>NODEJS_ORG_MIRROR=https://cdn.npmmirror.com/binaries/node
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="git相关的" tabindex="-1"><a class="header-anchor" href="#git相关的" aria-hidden="true">#</a> git相关的</h2><h3 id="git一次性拉去所有分支更新组合拳" tabindex="-1"><a class="header-anchor" href="#git一次性拉去所有分支更新组合拳" aria-hidden="true">#</a> git一次性拉去所有分支更新组合拳</h3><p>一次性采集所有分支,并进行pull更新</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> fetch <span class="token parameter variable">--all</span>
<span class="token comment"># 项目 </span>
<span class="token function">git</span> pull <span class="token parameter variable">--all</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="追踪文件名大小写" tabindex="-1"><a class="header-anchor" href="#追踪文件名大小写" aria-hidden="true">#</a> 追踪文件名大小写</h3><p>由于默认的git不会追踪文件大小写,这会导致一些问题,白白浪费我们的时间来排查问题,我们可以防患于未然,执行以下命令在未来杜绝这个问题</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 全局</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="vscode-备忘录" tabindex="-1"><a class="header-anchor" href="#vscode-备忘录" aria-hidden="true">#</a> vscode 备忘录</h2><h3 id="代码注释折叠标志-region-endregion" tabindex="-1"><a class="header-anchor" href="#代码注释折叠标志-region-endregion" aria-hidden="true">#</a> 代码注释折叠标志 #region #endregion</h3><p>它可以让你把相关的代码折叠到一起,而无需和语法挂钩.</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// #region xxx功能区域</span>
<span class="token comment">// ...code</span>
<span class="token comment">// #endregion</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,31);function _(y,R){const e=l("ExternalLinkIcon");return d(),t("div",null,[o,p,m,n("ul",null,[n("li",null,[n("a",u,[s("nvm win地址"),a(e)])]),n("li",null,[n("a",v,[s("微软wsl2"),a(e)])]),n("li",null,[n("a",b,[s("win镜像地址"),a(e)])])]),h,n("p",null,[s("在"),g,s("文件内加入以下内容,从"),k,s("博客上看来的,经过测试过相当快~ 原文链接:"),n("a",f,[s("https://antfu.me/posts/npm-binary-mirrors"),a(e)])]),x])}const N=r(c,[["render",_],["__file","zaxiangbijihuizong.html.vue"]]);export{N as default};
